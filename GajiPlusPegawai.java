...
public class GajiPlusPegawai {
    ...
    public GajiPlusPegawai(String namaDepan, String namaBelakang, String nomorKTP, double penjualan, double komisi, double gajiPokok) {
